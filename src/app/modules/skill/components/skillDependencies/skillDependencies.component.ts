import {AddSkillDependencyComponent} from "../addSkillDependency/addSkillDependency.component";
...
@Component({
  ...
  directives: [SkillDependenciesListComponent, AddSkillDependencyComponent]
})
