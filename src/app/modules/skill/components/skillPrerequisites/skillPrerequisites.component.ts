import {AddSkillPrerequisiteComponent} from "../addSkillPrerequisite/addSkillPrerequisite.component";
...
@Component({
  ...
  directives: [SkillPrerequisitesListComponent, AddSkillPrerequisiteComponent]
})
